...
export function DashboardSidebar({ role, isOpen, onClose }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed bottom-0 top-0 left-0 z-50 flex w-64 flex-col border-r border-border bg-card/60 backdrop-blur-xl transition-transform duration-300 md:sticky md:top-0 md:h-screen md:translate-x-0 ${
