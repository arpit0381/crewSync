...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 md:w-96 rounded-2xl border border-border bg-card/95 backdrop-blur-xl shadow-2xl z-50 overflow-hidden flex flex-col max-h-[80vh]">
